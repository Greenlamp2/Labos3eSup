...
keytool -genkey -alias client -keystore client_keystore.jks
keytool -genkey -alias server -keystore serveur_keystore.jks

keytool -certreq -alias client -keystore client_keystore.jks -file clientJsse.csr -keypass password -storepass password -v
...
keytool -import -v -alias certifauthority -file demoCA\cacert.pem -keystore client_keystore -storepass password
keytool -import -v -keystore client_keystore -alias client -file clientJsse.der -storepass password
