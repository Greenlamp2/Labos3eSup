...
public class Connexion extends javax.swing.JFrame {
    ...
    public Connexion() {
        initComponents();
        host = EasyFile.getConfig("Configs_Serveur_Chat-Hollidays", "HOST");
        portGroup = Integer.parseInt(EasyFile.getConfig("Configs_Serveur_Chat-Hollidays", "PORT_GROUP"));
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(verifChamps()){
            socket = new NetworkClient(host, portGroup);
            if(!socket.isConnected()){
                ...
                PacketCom packet = new PacketCom(FECOP.LOGIN_GROUP, (Object)login);
                socket.send(packet);
    ...
    private void traitementPacket(PacketCom packetReponse) {
        ...
        if(type.equalsIgnoreCase(FECOP.LOGIN_GROUP_OUI)){
            Object[] infos = (Object[]) contenu;
            String ipUdp = (String)infos[0];
            String portUdp = (String)infos[1];
            Main main = new Main(socket, ipUdp, portUdp, this.login);
            main.setVisible(true);
            this.dispose();
        }else if(type.equalsIgnoreCase(FECOP.LOGIN_GROUP_NON)){
